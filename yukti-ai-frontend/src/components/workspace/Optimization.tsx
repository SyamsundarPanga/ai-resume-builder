            ...
            return (
              <div key={skill} className="p-4 border border-[#B8860B]/10 rounded-2xl space-y-3 bg-[#F7F4ED]/5">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <span className="font-bold text-sm text-[#1A1A1A] dark:text-[#F7F4ED]">{skill}</span>
                ...
                {isConfirmed && (
                  <motion.div
                    ...
                    className="space-y-1.5 pt-2 border-t border-[#B8860B]/5"
                  >
                    <label className="block text-[10px] text-slate-500 font-bold uppercase tracking-wider">
                      Describe your experience or context (Optional)
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder="e.g. Architected core microservice, managed deployments..."
                    />
                  </motion.div>
                )}
              </div>
